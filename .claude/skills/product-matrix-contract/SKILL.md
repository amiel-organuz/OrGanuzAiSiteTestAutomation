...
**Network-free** specs (import `test`/`expect` from `@playwright/test`, no fixtures/browser) that assert the shape of the checked-in matrix data. Part of the active `product` project. 23 tests.
